...
$(function() {    
 ...
 var target = 1000000;
 var raised = document.getElementById("orderTotal").value;;

    progressCounter('#hours-available-progress', 38, 2, "#F06292", 0.68, "icon-watch text-pink-400", 'Hours available', '64% average')
   //progressCounter('#goal-progress', 60, 20, "#5C6BC0", 0.87, "icon-trophy3 text-indigo-800", tokenname, 'Capital Raised : $870,000 ')
    progressCounter('#goal-progress', 60, 20, "#5C6BC0", raised/target, "icon-trophy3 text-indigo-800", "Capital Target $: "+target, 'Capital Raised $: ' + raised)
    // Chart setup
